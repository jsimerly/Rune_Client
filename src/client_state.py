...
class ClientState:
    ...
    def set_game_states(self, states: dict[str, AbstractClientState]):
        self.states = states

    def update_state(self, state_name: str, on_enter_data:dict=None):
        self.state = self.states[state_name]
        self.state.on_enter(on_enter_data)
